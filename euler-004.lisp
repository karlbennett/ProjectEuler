...
(terpri)
(format t "Split 1234567: ~A~%" (split-number 123456))
(format t "Palindrom-Check 1234321: ~A~%" (palindrom-number-check 1234321))
(format t "make-max-number 3: ~A~%" (make-max-number 3))
(format t "palindrom-multiple-find 3: ~A~%" (palindrom-multiple-find 3))
(quit)
